...
# Few-shot
bash scripts/fewshot/ETT/iTransformer_ETTh1.sh
bash scripts/fewshot/ETT/iTransformer_ETTh2.sh
bash scripts/fewshot/ETT/iTransformer_ETTm1.sh
bash scripts/fewshot/ETT/iTransformer_ETTm2.sh
